...
const signup = () => {
    ...
    const onFormSubmit=(data)=>{
        ...
        fetch("http://127.0.0.1:5463/student_register/",
        {
            method:'POST',
            body:formData
        }
                ...
                <div className=''>
                    <div className='w-[420px] h-[600px] bg-gray-100 shadow-md shadow-slate-900 p-5'>
                       <form onSubmit={ handleSubmit(onFormSubmit)} action="">
                        ...
                        <div>
                        <input className='w-96 py-2 px-1' type="text" {...register("student_name",{required:true})}/> 
                         {errors.student_name &&<span className='text-red-600'>please fill student name</span>}
                        </div>   
                        </div>
                       <div className='mb-3'>
